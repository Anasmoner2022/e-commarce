...
const NavBar = () => {
  ...
  return (
    <div className='flex justify-between items-center font-medium'>
        <img src={assets.logo} className='w-2/12 min-w-44' alt="Anas-logo" />
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link to='/cart' className='relative'>
                ...
                <p className='absolute right-[-5px] bottom-[-5px] w-4 leading-4 aspect-square text-[8px] bg-black text-white rounded-full text-center '>10</p>
            </Link>
            <img onClick={()=>{setVisible(true)}} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden' alt="Menu-Icon" />
        </div>

        {/* Sidebar menu for small screens */}
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'} cursor-pointer`}>
